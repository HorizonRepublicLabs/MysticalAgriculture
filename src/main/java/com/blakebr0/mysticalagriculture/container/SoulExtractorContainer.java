...
public class SoulExtractorContainer extends BaseContainerMenu {
    ...
    private SoulExtractorContainer(MenuType<?> type, int id, Inventory playerInventory, BaseItemStackHandler inventory, MachineUpgradeItemStackHandler upgradeInventory, BlockPos pos) {
        super(type, id, pos);
    ...
    public static SoulExtractorContainer create(int windowId, Inventory playerInventory, BaseItemStackHandler inventory, MachineUpgradeItemStackHandler upgradeInventory, BlockPos pos) {
